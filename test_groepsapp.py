...
from app import create_app, parse_scopes
...
class Tests(unittest.TestCase):
    ...
    def test_scope_parser_accepts_strava_space_delimited_response(self):
        self.assertIn(
            "activity:read_all",
            parse_scopes("read activity:read_all"),
        )

    def test_scope_parser_accepts_callback_comma_delimited_response(self):
        self.assertEqual(
            parse_scopes("read,activity:read_all"),
