...
Op de beveiligde rapportpagina kun je voortaan:

- met één knop het rapport van gisteren maken;
- via een datumkiezer een andere voorbije datum selecteren;
- het gegenereerde historische rapport meteen in WhatsApp delen.

De URL-vorm is:

```text
/rapport/maken?datum=2026-06-24
```

Toekomstige datums worden geweigerd.
