...
def create_app(settings: Settings | None = None) -> Flask:
    ...
    def callback():
        ...
        accepted_scope = str(token_data.get("scope") or request.args.get("scope") or "")
        if "activity:read_all" not in accepted_scope.split(","):
            abort(400, "De vereiste toestemming voor activiteiten werd niet gegeven.")
